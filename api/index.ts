...
6. CRITICAL: Do NOT use any markdown characters or formatting symbols whatsoever. Do NOT use asterisks (*) for bullet points, emphasis, or bold text. Do NOT use hashes (#) for headings. Do NOT use backticks (\`) or underscores (_). If you want to show sentence patterns, words, or grammar formulas, use normal single/double quotes or standard brackets (e.g. 'Mệnh đề 1; however, Mệnh đề 2' or 'hospitable'), NEVER write them in code blocks or with bold tags. Write complete, clean, human sentences that are ready for text-to-speech output.`;
